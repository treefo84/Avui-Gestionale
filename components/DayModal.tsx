...
import { Activity, Assignment, AssignmentStatus, Availability, AvailabilityStatus, Boat, Role, User, GeneralEvent, ConfirmationStatus, DayNote, MaintenanceRecord } from '../types';
...
interface DayModalProps {
  ...
  onCreateGeneralEvent: (date: string, activityId: string, startTime?: string, endTime?: string, notes?: string) => void;
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-8">
          ...
          <section>
            ...
            <div className={`flex items-center gap-4 p-4 rounded-xl border transition-colors ${
                myStatus === AvailabilityStatus.AVAILABLE ? 'bg-emerald-50 border-emerald-100' :
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                    myStatus === AvailabilityStatus.AVAILABLE 
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                    myStatus === AvailabilityStatus.UNAVAILABLE 
